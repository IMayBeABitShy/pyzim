...
class ZimWriterTests(unittest.TestCase, TestBase):
    ...
    @cvar TEST_ZIM_META: metadata for test zim file
    @type TEST_ZIM_META: L{dict} of L{str} -> L{str}
    @cvar NUM_ENTRIES: expected number of entries in the ZIM
    ...
    NUM_ENTRIES = 5 + 2 + 1 + len(TEST_ZIM_META)  # 5 items, 2 title lists, 1 redirect
